...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedReaderContract.FeedEntry.TABLE_NAME + " (" +
                    ...
                    FeedReaderContract.FeedEntry.COLUMN_PRODUCT_NAME + " TEXT, " +
                    FeedReaderContract.FeedEntry.COLUMN_PRICE + " REAL, " +
                    FeedReaderContract.FeedEntry.COLUMN_QUANTITY + " INTEGER, " +
                    FeedReaderContract.FeedEntry.COLUMN_SUPPLIER_NAME + " TEXT, " +
                    FeedReaderContract.FeedEntry.COLUMN_SUPPLIER_PHONE_NUMBER + " TEXT)";
